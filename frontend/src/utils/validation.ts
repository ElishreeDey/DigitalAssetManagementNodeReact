 ...
 ****************************************************************************************************************************
 * Filename    : validation
 * Description : Pure validation functions for login form fields — no side effects, fully unit-testable
 * Author      : Elishree Dey Chand
 * Created     : 2026-06-12
 ****************************************************************************************************************************
 */

import { EMAIL_REGEX, PASSWORD_MIN_LENGTH, AUTH_ERRORS } from '../constants/auth'
import type { LoginFormFields, LoginFormErrors } from '../types/auth'
